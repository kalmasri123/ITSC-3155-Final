...
vaccinationsRatioData = [
    go.Bar(x=vaccinationsDf['COUNTRY'],
           y=vaccinationsDf['PERSONS_FULLY_VACCINATED_PER100'], name="Fully Vaccinated"),
    go.Bar(x=vaccinationsDf['COUNTRY'], y=vaccinationsDf['PERSONS_BOOSTER_ADD_DOSE_PER100'],
           name="Fully Vaccinated + Booster")
]

vaccinationsData = [
    go.Bar(x=vaccinationsDf['COUNTRY'],
           y=vaccinationsDf['PERSONS_FULLY_VACCINATED'], name="Fully Vaccinated"),
    go.Bar(x=vaccinationsDf['COUNTRY'], y=vaccinationsDf['PERSONS_BOOSTER_ADD_DOSE'],
           name="Fully Vaccinated + Booster")
]
